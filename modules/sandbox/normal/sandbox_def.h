...
constexpr static mode_t DIR_MODE = 0711;
...
constexpr const char *g_createOnlyOnDaemon = "create-only-on-daemon";
constexpr const char *g_createOnlyPath = "path";
constexpr const char *g_restorecon = "restorecon";
...
constexpr const char *g_controlledFusePath = "controlled-fuse-path";
constexpr const char *g_controlledSkip = "controlled-skip";
