...
static const uint32_t GID_USBMONS[] = { 3825 };
...
static const PermissionAttrMap g_permissionAttrMap[] = {
    ...
    {"ohos.permission.kernel.USB_CAPTURE", {APPSPAWN_CAP_NONE, false}, {GID_USBMONS, ARRAY_LENGTH(GID_USBMONS)}},
};
