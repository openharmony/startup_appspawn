...
typedef enum {
    ...
    ERR_APPSPAWN_PRCTL_FAIL,
    ERR_APPSPAWN_MSG_PARAM_INVALID,
...
// abnormal scene key event names
#define FORK_FAIL "FORK_FAIL"
#define PREFORK_FAIL "PREFORK_FAIL"
#define CHILDLOOPER_NOT_REGISTERED "CHILDLOOPER_NOT_REGISTERED"
#define SET_BOOTEVENT_PARAM_FAIL "SET_BOOTEVENT_PARAM_FAIL"
