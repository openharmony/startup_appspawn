...
typedef enum {
    ...
    APPSPAWN_ERROR_MSG_INVAILD,
} SpawnerErrorCode;

typedef enum {
    SANDBOX_ERROR_ARGS_INVAILD = DECLARE_APPSPAWN_ERRORCODE(APPSPAWN_SANDBOX, APPSPAWN_SANDBOX_COMMON, 0x0000),
    SANDBOX_ERROR_MSG_INVAILD,
} SandboxErrorCode;
