...
int HnpShowHelp(int argc, char *argv[])
{
    ...
    HNP_LOGI("\r\nusage:hnp <command> <args> [-u <user id>][-p <hap package name>][-i <hap install path>][-f]"
        ...
        "\r\n           -I    : [optional]    appIdentifier, This parameter needs to be transferred when an independent"
            " signed hnp package needs to be specified"
        "\r\n           -S    : [optional]    The path of the independent sign hnp packet, must be used together"
