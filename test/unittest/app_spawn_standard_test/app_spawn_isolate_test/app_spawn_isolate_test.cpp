...
namespace OHOS {
static IsolateTestHelper g_testHelper;
...
HWTEST_F(AppSpawnIsolateTest, App_Spawn_SetIsolateDir, TestSize.Level0)
{
    ...
    do {
        ...
        reqHandle = g_testHelper.IsolateTestCreateSendMsg(clientHandle, MSG_APP_SPAWN);
        ...
        property = g_testHelper.IsolateTestGetAppProperty(clientHandle, reqHandle);
