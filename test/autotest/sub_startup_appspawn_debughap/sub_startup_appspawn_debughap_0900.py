...
class SubStartupAppspawnDebughap0900(TestCase):
    ...
    def process(self):
        ...
        result = self.driver.shell("ls -Z /mnt/debug/100")
        self.driver.Assert.contains(result, "u:object_r:sharefs:s0 debug_hap")
