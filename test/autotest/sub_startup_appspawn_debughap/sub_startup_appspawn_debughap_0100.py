...
class SubStartupAppspawnDebughap0100(TestCase):
    ...
    def process(self):
        Step("安装测试hap并打开")
        bundle_name = "com.example.release"
        ...
        release_has = self.driver.Storage.has_dir("/mnt/debug/100/debug_hap/%s" % bundle_name)
        self.driver.Assert.equal(release_has, False)
