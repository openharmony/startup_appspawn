...
class SubStartupAppspawnNativesandbox0200(TestCase):
    ...
    def test_step1(self):
        ...
        self.driver.shell("mkdir -p data/com.example.hnptestapplication/private")
        Step("步骤2：导入安装包文件hnp")
        ...
        self.driver.push_file(hnp, "data/com.example.hnptestapplication/private/")
        self.driver.push_file(hap, "data/com.example.hnptestapplication")
        Step("步骤3：执行安装命令")
        self.driver.shell(
            "hnp install -u 100 -p com.example.hnptestapplication -i data/com.example.hnptestapplication  -s data/com.example.hnptestapplication/entry-default-signedArm64-test11.hap -a arm64 -f")
        Step("步骤4：查看是是否安装成功")
        public = self.driver.shell("ls /data/app/el1/bundle/100/hnp/com.example.hnptestapplication")
        ...
        result = self.driver.shell("ls /proc/%d/root/data/app" % pid)
        Step("步骤9：预期结果校验")
        Step("识别设备型号...............................")
    ...
    def teardown(self):
        self.driver.shell("hnp uninstall -u 100 -p com.example.hnptestapplication")
