...
from hypium import SomeClass, some_function

from aw import Common


class Substartupappspawncgroups0200(TestCase):
    ...
    def process(self):
        hap_path = Common.sourcepath('ForkTest2.hap', "SUB_STARTUP_APPSPAWN_CGROUPS")
    ...
    def teardown(self):
        Step("收尾工作.................")
        self.driver.AppManager.uninstall_app("com.example.exe_sys_cmd")