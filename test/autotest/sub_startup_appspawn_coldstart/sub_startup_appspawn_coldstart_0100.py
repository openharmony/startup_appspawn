...
class Substartupappspawncoldstart0100(TestCase):
    ...
    def test_step1(self):
        ...
        Step("通过命令启动日历.................")
        result = self.driver.shell("aa start -C -d 123456 -a MainAbility -b com.calendar")
        sleep(3)
        self.driver.Assert.contains(result, "start ability successfully.", "通过命令启动日历失败！")
        Step("检查日历冷启动进程.................")
        result_ps = self.driver.shell("ps -ef|grep com.calendar")
    ...
    def teardown(self):
        Step("收尾工作.................")
        pid = self.driver.System.get_pid('com.calendar')
