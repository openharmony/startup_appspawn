...
class Substartupappspawnsupplementary0100(TestCase):
    ...
    def setup(self):
        ...
        Step("安装测试hap.................")
        sourpath = Common.sourcepath("asan.hap", "SUB_STARTUP_APPSPAWN_SUPPLEMENTARY")
        Step(sourpath)
    ...
    def test_step1(self):
        ...
        sleep(3)
        Step("校验hap显示Hello World.................")
        if not self.driver.find_component(BY.text("Hello World")):
           throw std::runtime_error("Failed to find component with text 'Hello'")
