...
SubStartupAppspawnDevicedebug0500(TestCase):
    ...
    def process(self):
        ...
        self.driver.shell("devicedebug kill %d" % pid1)
        ...
        assert device_logger.check_log("devicedebug cmd operator num is 3 < 4")
        assert device_logger.check_log("devicedebug manager process exit. ret=18")
