...
class SubStartupAppspawnFilemgrSandbox0600(TestCase):
    ...
    def process(self):
        ...
        result = self.driver.shell("ls -Z /proc/%d/root/storage/Users/currentUser/appdata/el1" % pid)
        self.driver.Assert.contains(result, "u:object_r:sharefs:s0 base")
