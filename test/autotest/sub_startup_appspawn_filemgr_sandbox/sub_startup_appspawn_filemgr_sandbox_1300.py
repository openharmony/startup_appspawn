...
class SubStartupAppspawnFilemgrSandbox1300(TestCase):
    ...
    def process(self):
        ...
        result = self.driver.shell("ls -Z /proc/%d/root/storage/Users" % pid).rsplit("\n")
        self.driver.Assert.equal(result[0], "u:object_r:sharefs:s0 currentUser")
