...
class SubStartupAppspawnFilemgrSandbox0200(TestCase):
    ...
    def process(self):
        ...
        result = self.driver.shell("ls /proc/%d/root/storage/Users/currentUser" % pid).split()
        content = ["Desktop", "Documents", "Download", "appdata"]
        for i in content:
