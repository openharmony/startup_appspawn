...
class SubStartupAppspawnFilemgrSandbox0700(TestCase):
    ...
    def process(self):
        ...
        result = self.driver.shell("ls /proc/%d/root/storage/Users/currentUser/appdata/el2/distributedfiles" % pid,).split()
        for bundle_name in result:
            if "com." in bundle_name or "com.ohos" in bundle_name:
                count += 1
