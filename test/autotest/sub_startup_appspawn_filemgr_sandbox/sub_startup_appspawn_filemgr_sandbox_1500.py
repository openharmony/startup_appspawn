...
class SubStartupAppspawnFilemgrSandbox1500(TestCase):
    ...
    def process(self):
        ...
        result = self.driver.shell("ls -Z /proc/%d/root/storage/Users/currentUser/appdata/el2" % pid)
        content = ["base", "distributedfiles", "cloud"]
        for i in content:
            self.driver.Assert.contains(result, "sharefs_appdata_file:s0 %s" % i)
