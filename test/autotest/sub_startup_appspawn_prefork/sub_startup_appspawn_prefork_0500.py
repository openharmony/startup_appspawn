...
class SubStartupAppspawnPrefork0500(TestCase):
    ...
    def test_step1(self):
        ...
        Step("设置开机未完成状态..........................")
        self.driver.shell("param set bootevent.boot.completed false")
        Step("开启日志..........................")
        ...
        Step("校验日志内容..........................")
        device_logger.check_not_exist_keyword("prefork fork finish")
    ...
    def teardown(self):
        ...
        self.driver.stop_app("com.huawei.hmos.notepad")
        Step("设置开机完成状态..........................")
        self.driver.shell("param set bootevent.boot.completed true")
        Step("恢复日志级别..........................")
