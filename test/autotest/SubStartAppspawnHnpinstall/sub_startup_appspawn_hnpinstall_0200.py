...
class SUB_STARTUP_APPSPAWN_HNPINSTALL_0200(TestCase):
    ...
    def test_step1(self):
        ...
        self.driver.Assert.contains(result1, "hnpsample")
        Step("是否刷root包")
        ...
        if("Permission denied" in isroot):
            ...
            Step("步骤3：读取私有目录列表")
            result2 = self.driver.shell("cat /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/hnp.json")
            self.driver.Assert.contains(result2, "node")
