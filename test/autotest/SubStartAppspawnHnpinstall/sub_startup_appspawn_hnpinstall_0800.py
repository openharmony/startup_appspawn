...
class SUB_STARTUP_APPSPAWN_HNPINSTALL_0800(TestCase):
    ...
    def test_step1(self):
        ...
        if ("Permission denied" in isroot):
            ...
            result1 = self.driver.shell(
                f"cp /data/app/el1/bundle/100/hnppublic/hnpsample.org/hnpsample_1.1/hnp.json /data/app/el1/bundle/100/hnppublic/hnpsample.org/hnpsample_1.1/zsj.json")
            self.driver.Assert.contains(result1, "Permission denied")
            Step("步骤3：修改私有目录文件内容")
            result2 = self.driver.shell(
                f"cp /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/hnp.json /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/zsj.json")
            ...
            self.driver.Assert.contains(result1, "hnp.json")
            Step("步骤3：修改私有目录文件内容")
            self.driver.shell(
                f"cp /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/hnp.json /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/zsj.json")
            result2 = self.driver.shell(
            ...
            self.driver.Assert.contains(result2, "hnp.json")
