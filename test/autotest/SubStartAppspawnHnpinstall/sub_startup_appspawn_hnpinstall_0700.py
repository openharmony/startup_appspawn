...
class SUB_STARTUP_APPSPAWN_HNPINSTALL_0700(TestCase):
    ...
    def test_step1(self):
        ...
        if ("Permission denied" in isroot):
            Step("步骤2：修改公有目录文件内容")
            result1 = self.driver.shell(
                f"mv /data/app/el1/bundle/100/hnppublic/hnpsample.org/hnpsample_1.1/hnp.json /data/app/el1/bundle/100/hnppublic/hnpsample.org/hnpsample_1.1/zsj.json")
            self.driver.Assert.contains(result1, "Permission denied")
            Step("步骤3：修改私有目录文件内容")
            result2 = self.driver.shell(
                f"mv /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/hnp.json /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/zsj.json")
            self.driver.Assert.contains(result2, "Permission denied")
        else:
            Step("步骤2：修改公有目录文件内容")
            self.driver.shell(f"mv /data/app/el1/bundle/100/hnppublic/hnpsample.org/hnpsample_1.1/hnp.json /data/app/el1/bundle/100/hnppublic/hnpsample.org/hnpsample_1.1/zsj.json")
            result1 = self.driver.shell("ls  /data/app/el1/bundle/100/hnppublic/hnpsample.org/hnpsample_1.1/")
            self.driver.Assert.contains(result1, "zsj.json")
            Step("步骤3：修改私有目录文件内容")
            self.driver.shell(f"mv /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/hnp.json /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/zsj.json")
            result2 = self.driver.shell(
                "ls  /data/app/el1/bundle/100/hnp/com.example.hnp_test/node.org/node_1.0/")
            self.driver.Assert.contains(result2, "zsj.json")
