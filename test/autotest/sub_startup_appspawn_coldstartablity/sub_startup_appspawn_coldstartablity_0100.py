...
class Substartupappspawncoldstartablity0100(TestCase):
    ...
    def setup(self):
        ...
        Step("安装测试hap.................")
        sourpath = Common.sourcepath("asan-enable.hap", "SUB_STARTUP_APPSPAWN_COLDSTARTABLITY")
        Step(sourpath)
    ...
    def test_step1(self):
        ...
        Step(pid)
        Step("校验hap应用的maps.................")
        result = self.driver.shell('cat ' + os.path.join('/proc', str(pid), 'maps') + '|grep libclang.asan.so')
        Step(result)
